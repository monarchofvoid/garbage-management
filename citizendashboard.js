...
// ========== KPI ==========
function updateKPIs() {
  $("kpiOpenReports").textContent = Math.floor(Math.random() * 5 + 2);
  $("kpiAvgResolution").textContent = (Math.random() * 24).toFixed(1) + " hrs";
  $("kpiCityScore").textContent = (Math.random() * 20 + 70).toFixed(0) + "%";
  $("kpiRewardPoints").textContent = Math.floor(Math.random() * 200 + 50);
}
updateKPIs();
